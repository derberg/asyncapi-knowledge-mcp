#!/usr/bin/env bash
# Single source of truth for the asyncapi-researcher persona is agent/asyncapi-researcher.md.
...
SRC="agent/asyncapi-researcher.md"
DEST="plugins/asyncapi-knowledge/agents/asyncapi-researcher.md"
BANNER="<!-- GENERATED from agent/asyncapi-researcher.md by scripts/sync-agent.sh — do not edit directly. -->"
