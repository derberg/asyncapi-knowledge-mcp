...
This file is the CANONICAL asyncapi-researcher persona — the single source of truth.
It is consumed in two places:
  1. plugins/asyncapi-knowledge/agents/asyncapi-researcher.md — generated copy, written by
     scripts/sync-agent.sh (CI fails if it drifts).
  2. lib/chat/persona.generated.ts — the chat function's system prompt,
     bundled by scripts/bundle-persona.mjs at build time.
